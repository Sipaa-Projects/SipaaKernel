...
extern uint64_t *Vmm_KernelPML4;
...
typedef char KSymbol[];

extern KSymbol TextStartLD;
extern KSymbol TextEndLD;

extern KSymbol RoDataStartLD;
extern KSymbol RoDataEndLD;

extern KSymbol DataStartLD;
extern KSymbol DataEndLD;
